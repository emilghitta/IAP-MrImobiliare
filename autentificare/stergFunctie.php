...
//Prima data executam query-ul si stomac return-ul in variabila $rez care v-a fi apoi utilizata in alta variabila %folder ce o sa contina path-ul catre poze + numele pozei luat ca rezultat al query-ului
...
//Executam Comanda generala de stergere
